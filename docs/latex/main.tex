...
\\begin{abstract}
    ...
    %%% SUGGESTION: The abstract currently mixes architectural claims, cognitive motivation, and empirical observations together. Consider narrowing the abstract to:
    %%% SUGGESTION: (1) what HexNNs are,
    %%% SUGGESTION: (2) what experimental question is tested,
    %%% SUGGESTION: (3) the strongest observed result.
    %%% SUGGESTION: Journals and stronger conference submissions usually expect the abstract to avoid speculative framing.
\\end{abstract}
...
%%% SUGGESTION: This paper likely benefits from an explicit limitations section.
...
%%% NOTE: Future work should stay tightly coupled to the paper's core thesis.
%%% NOTE: Rotational transfer, synchronization schedules, lesioning, and nested-core studies are appropriate.
%%% NOTE: The maze system and Hofstadter/attractor explorations should likely remain out-of-scope for this paper except perhaps one sentence of broader future directions.
