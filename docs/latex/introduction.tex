...
This design enables six distinct orientations of the same network, each corresponding to a $60\deg$ rotation of the hexagonal structure.  
We define each orientation as a subset of the network, $H_i$, and note that forward propagation of any $H_i$ is equivalent to backwards propagation of its  corresponding opposite network, $H_{i+3\mod6}$.
